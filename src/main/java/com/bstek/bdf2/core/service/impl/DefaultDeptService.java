...
public class DefaultDeptService extends CoreJdbcDao implements IDeptService {
	...
	public List<IDept> loadUserDepts(String username) {
		String sql="SELECT D.ID_,D.NAME_,D.DESC_,D.COMPANY_ID_,D.PARENT_ID_ FROM BDF2_USER_DEPT UD LEFT JOIN BDF2_DEPT D ON UD.DEPT_ID_=D.ID_ WHERE UD.USERNAME_=?";
