...
public class DefaultPositionService extends CoreJdbcDao implements
	...
	public List<IPosition> loadUserPositions(String username) {
		String sql = "SELECT P.ID_,P.COMPANY_ID_,P.NAME_,P.DESC_ FROM BDF2_USER_POSITION UP LEFT JOIN BDF2_POSITION P ON UP.POSITION_ID_ = P.ID_ WHERE UP.USERNAME_=?";
